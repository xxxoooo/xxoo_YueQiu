...
//    {
//        NearbyFragmentsCommonUtils.setFragmentEmptyTextView(mContext, mSubFragmentListView,mEmptyView, mContext.getString(R.string.search_activity_subfragment_empty_tv_str), whetherHide);
//    }
