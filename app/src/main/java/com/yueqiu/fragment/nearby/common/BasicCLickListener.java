 ...
 */
public class BasicCLickListener implements View.OnClickListener{
    ...
    public BasicCLickListener(Context context,Handler handler,NearbyParamsPreference preference){
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_coauch_ability:
                final String[] levelStrList = {
                        mContext.getResources().getString(R.string.search_coauch_filter_level_guojiadui), // TODO: 现在服务端还没有定义每一个教练所对应的级别的具体的称号
                        // TODO: 我们这里也是暂时命名 1
