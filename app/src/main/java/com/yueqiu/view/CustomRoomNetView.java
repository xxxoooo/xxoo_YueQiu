...
/**
 * Created by wangyun on 15/3/12.
 */
public class CustomRoomNetView extends ImageView{
    ...
    public CustomRoomNetView(Context context) {
        this(context, null);
    }

    public CustomRoomNetView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomRoomNetView(Context context, AttributeSet attrs, int defStyle) {
                ...
                new ImageLoader.ImageListener() {
                    ...
                    public void onResponse(final ImageLoader.ImageContainer response, boolean isImmediate) {
                        ...
                        if (response.getBitmap() != null) {
                            setImageBitmap(ImgUtil.toRoundCorner(response.getBitmap(), 8));
                            setScaleType(ImageView.ScaleType.FIT_XY);
                        } else if (mDefaultImageId != 0) {
                            setImageResource(mDefaultImageId);
                        }
                    }
                }, getResources().getDimensionPixelOffset(R.dimen.account_photo_height), getResources().getDimensionPixelOffset(R.dimen.account_photo_width));
