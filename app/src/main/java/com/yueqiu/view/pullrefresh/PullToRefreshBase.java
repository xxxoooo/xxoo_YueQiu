 ...
 *******************************************************************************/
package com.yueqiu.view.pullrefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs,Type type) {
		LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
				getPullToRefreshScrollDirection(), attrs,type);
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener) {
            ...
            /**
             * PULL_FROM_END 代表上拉刷新
             * PULL_FROM_START 代表下拉刷新
             */
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a,Type.Hearder);
		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a,Type.Footer);
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs,Type type) {
			switch (this) {
				//case ROTATE:
				default:
					//return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
				//case FLIP:
					return new FlipLoadingLayout(context, mode, scrollDirection, attrs,type);
			}
		}
	}
